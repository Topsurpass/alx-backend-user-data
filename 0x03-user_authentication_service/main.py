...
def register_user(email: str, password: str) -> None:
    """Tests registering a new user (new email and password)
    """
...
def log_in_wrong_password(email: str, password: str) -> None:
    """Tests logging in user with a wrong password.
    """
...
def log_in(email: str, password: str) -> str:
    """Tests logging in with correct username and password
    and check if cookie was created
    """
    url = "{}/sessions".format(BASE_URL)
    body = {
        'email': email,
